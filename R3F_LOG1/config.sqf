 ...
 *            You can disable some objects with : object setVariable ["R3F_LOG1_disabled", true];
 * If true :  all objects are disabled by default
 *            You can enable some objects with : object setVariable ["R3F_LOG1_disabled", false];
 * 
 * 
 * (FR)
 ...
 *            Vous pouvez désactiver certains objets avec : objet setVariable ["R3F_LOG1_disabled", true];
 * Si true :  tous les objets sont inactifs par défaut
 *            Vous pouvez activer quelques objets avec : objet setVariable ["R3F_LOG1_disabled", false];
 */
R3F_LOG1_CFG_disabled_by_default = false;
 ...
 * value of the config variable R3F_LOG1_CFG_unlock_objects_timer.
 * 
 ...
 * 
 * See also the config variable R3F_LOG1_CFG_unlock_objects_timer.
 * 
 * (FR)
 ...
 * valeur de la variable de configiration R3F_LOG1_CFG_unlock_objects_timer.
 * 
 ...
 * 
 * Voir aussi la variable de configiration R3F_LOG1_CFG_unlock_objects_timer.
 */
R3F_LOG1_CFG_lock_objects_mode = "none";
 ...
 * See also the config variable R3F_LOG1_CFG_lock_objects_mode.
 * 
 ...
 * Voir aussi la variable de configiration R3F_LOG1_CFG_lock_objects_mode.
 */
R3F_LOG1_CFG_unlock_objects_timer = 30;
 ...
 */
R3F_LOG1_CFG_no_gravity_objects_can_be_set_in_height_over_ground = true;
 ...
 */
R3F_LOG1_CFG_language = switch (language) do
{
	case "English":{"en"};
	case "French":{"fr"};
 ...
 */
R3F_LOG1_CFG_string_condition_allow_logistics_on_this_client = "true";
 ...
 * Pour autoriser l'usine de création chez tout le monde, il suffit de définir la condition à "true".
  */
R3F_LOG1_CFG_string_condition_allow_creation_factory_on_this_client = "false";
 ...
 */
R3F_LOG1_CFG_can_tow = R3F_LOG1_CFG_can_tow +
[
	"B_Truck_01_mover_F"
];
 ...
 */
R3F_LOG1_CFG_can_be_towed = R3F_LOG1_CFG_can_be_towed +
[     		
 ...
 */
R3F_LOG1_CFG_can_lift = R3F_LOG1_CFG_can_lift +
[
 ...
 */
R3F_LOG1_CFG_can_be_lifted = R3F_LOG1_CFG_can_be_lifted +
[
 ...
 */
R3F_LOG1_CFG_can_transport_cargo = R3F_LOG1_CFG_can_transport_cargo +
[
 ...
 */
R3F_LOG1_CFG_can_be_transported_cargo = R3F_LOG1_CFG_can_be_transported_cargo +
[
 ...
 */
R3F_LOG1_CFG_can_be_moved_by_player = R3F_LOG1_CFG_can_be_moved_by_player +
[
