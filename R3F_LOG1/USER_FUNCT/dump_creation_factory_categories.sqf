 ...
 * @usage nul = [] execVM "R3F_LOG1\USER_FUNCT\dump_creation_factory_categories.sqf";
 * 
 * @usage to not dump the comments after the class names, set the optional param 0 to false
 * @usage nul = [false] execVM "R3F_LOG1\USER_FUNCT\dump_creation_factory_categories.sqf";
 * 
 * @usage to dump all categories, including empty ones, set param 1 to true
 * @usage nul = [true, true] execVM "R3F_LOG1\USER_FUNCT\dump_creation_factory_categories.sqf";
 */
...
_retour_liste_cfgVehicles_par_categories = [objNull, _montrer_categories_vides] call R3F_LOG1_FNCT_recuperer_liste_cfgVehicles_par_categories;
...
diag_log text "R3F_LOG1_CFG_CF_your_own_categories_list =";
diag_log text "[";
